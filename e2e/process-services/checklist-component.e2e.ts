...
describe('Checklist component', () => {
    ...
    it('[C279976] Should no checklist be created when no title is typed', () => {
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', tasks[0]).selectRow('Name', tasks[0]);
    ...
    it('[C261026] Should Checklist number increase when a new checklist is added', () => {
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', tasks[1]).selectRow('Name', tasks[1]);
    ...
    it('[C279980] Should checklist be removed when clicking on remove button', () => {
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', tasks[2]).selectRow('Name', tasks[2]);
    ...
    it('[C261027] Should not be able to remove a completed Checklist when clicking on remove button', () => {
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', tasks[3]).selectRow('Name', tasks[3]);
        ...
        taskPage.tasksListPage().getDataTable().selectRow('Name', removeChecklist[3]);
        taskPage.completeTaskNoForm();
        taskPage.tasksListPage().getDataTable().checkContentIsNotDisplayed('Name', removeChecklist[3]);

        taskPage.tasksListPage().getDataTable().selectRow('Name', tasks[3]);
        taskPage.checkChecklistIsDisplayed(removeChecklist[2]);
        taskPage.checkChecklistIsDisplayed(removeChecklist[3]);
        expect(taskPage.getNumberOfChecklists()).toEqual('2');
    ...
    it('[C261028] Should all checklists of a task be completed when the task is completed', () => {
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', tasks[4]).selectRow('Name', tasks[4]);
        ...
        taskPage.tasksListPage().getDataTable().selectRow('Name', hierarchyChecklist[0]);
        ...
        taskPage.tasksListPage().getDataTable().selectRow('Name', hierarchyChecklist[1]);
        ...
        taskPage.tasksListPage().getDataTable().selectRow('Name', tasks[4]);
        taskPage.completeTaskNoForm();

        taskPage.filtersPage().goToFilter(CONSTANTS.TASK_FILTERS.COMPLETED_TASKS);
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', tasks[4]);
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', hierarchyChecklist[0]);
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', hierarchyChecklist[1]);
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', hierarchyChecklist[2]);
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', hierarchyChecklist[3]);
    });
