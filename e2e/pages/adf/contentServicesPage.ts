...
export class ContentServicesPage {
    ...
    getElementsDisplayedCreated() {
        // let list;
        // this.contentList.dataTablePage().getAllRowsColumnValues('Created').then(async (allDatesString) => {
        //     await allDatesString.forEach((dateString) => {
        //         list.push(new Date(dateString));
        //     });
        // });
